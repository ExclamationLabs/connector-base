...
public interface FullAccessInvocator<
   ...
   */
  String create(D driver, T configuration, M model) throws ConnectorException;
   ...
   */
  void update(D driver, T configuration, String userId, M userModel) throws ConnectorException;
   ...
   */
  void delete(D driver, T configuration, String userId) throws ConnectorException;
}
