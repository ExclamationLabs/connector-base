...
public class ConfigurationWriter {
  ...
  protected static void writeFromClass(
      Class<?> configClass, StringBuilder build, ConnectorConfiguration configuration) {
    for (Field field : configClass.getDeclaredFields()) {
      ...
      if (configInfo != null) {
        ...
        try {
          ...
          Logger.warn(
              ConfigurationWriter.class, "Error while reading field value " + field.getName(), ill);
        }
      }
    } // end for fields
  }
