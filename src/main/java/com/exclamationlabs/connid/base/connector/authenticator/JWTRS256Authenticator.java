 ...
 *
 * <p>Private key is required. This implementation does not utilize a public key since only the
 * private key is needed for signing.
 *
 * <p>Since a private key is required, this Authenticator must be subclassed and getPrivateKey()
 * overriden to get access to the required private key.
 *
  ...
  public String authenticate(JwtRs256Configuration configuration)
    ...
    try {
      ...
      throw new ConnectorSecurityException(
          "Unable to generate bearer token for authentication.", authE);
    }
  }
