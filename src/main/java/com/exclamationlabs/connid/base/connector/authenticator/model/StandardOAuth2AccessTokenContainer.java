...
/**
 * Model holding possible OAuth2 response data. Not all fields may be populated from response, but
 * accessToken should be expected to have a value from an OAuth2 response.
 */
public class StandardOAuth2AccessTokenContainer implements OAuth2AccessTokenContainer {
