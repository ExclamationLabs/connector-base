...
public class PEMRSAPrivateKeyLoader implements RSAPrivateKeyLoader<PemConfiguration> {
  ...
  @Override
  public RSAPrivateKey load(PemConfiguration configuration) throws ConnectorSecurityException {
    ...
    try (PEMParser pemParser = new PEMParser(new FileReader(pemFile))) {
      ...
      throw new ConnectorSecurityException(
          "File not found while loading " + "PEM file " + pemFile, fnfe);
    } catch (IOException ioe) {
      throw new ConnectorSecurityException("IO error while reading " + "PEM file " + pemFile, ioe);
    }
  }
}
