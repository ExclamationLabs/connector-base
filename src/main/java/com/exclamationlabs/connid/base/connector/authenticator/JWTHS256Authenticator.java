...
/**
 * This implementation performs the HS256 strategy. JWS: HS256 Algorithm: HMAC256 Description: HMAC
 * with SHA-256
 */
public class JWTHS256Authenticator implements Authenticator<JwtHs256Configuration> {

  @Override
  public String authenticate(JwtHs256Configuration configuration)
