...
public class EnhancedReturnsNameOnlyTest
    extends ApiIntegrationTest<EnhancedPFConfiguration, EnhancedReturnsNameOnlyTest.TestConnector> {
  ...
  @Override
  protected Class<EnhancedReturnsNameOnlyTest.TestConnector> getConnectorClass() {
    return EnhancedReturnsNameOnlyTest.TestConnector.class;
  }
