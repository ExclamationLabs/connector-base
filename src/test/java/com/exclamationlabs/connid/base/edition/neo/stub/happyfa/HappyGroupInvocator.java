...
public class HappyGroupInvocator
  ...
  @Override
  public String create(HappyDriver driver, StubConfiguration configuration, HappyGroupModel model)
  ...
  @Override
  public void update(
      HappyDriver driver, StubConfiguration configuration, String userId, HappyGroupModel userModel)
      throws ConnectorException {}

  @Override
  public void delete(HappyDriver driver, StubConfiguration configuration, String userId)
      throws ConnectorException {}
