...
public abstract class ConnectorMockNativeRestTest {
    ...
    @Mock
    protected HttpResponse<String> stubResponse;
    ...
    protected void prepareMockResponse(Map<String, String> responseHeaders, String... responseData) {
        try {
            ...
            Mockito.when(stubClient.send(any(HttpRequest.class), any(HttpResponse.BodyHandler.class))).thenReturn(stubResponse);
