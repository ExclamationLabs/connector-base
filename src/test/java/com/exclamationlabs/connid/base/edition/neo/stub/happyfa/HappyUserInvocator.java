...
public class HappyUserInvocator
  ...
  @Override
  public String create(HappyDriver driver, StubConfiguration configuration, HappyUserModel model)
      throws ConnectorException {
  ...
  @Override
  public void update(
      HappyDriver driver, StubConfiguration configuration, String userId, HappyUserModel userModel)
      throws ConnectorException {
